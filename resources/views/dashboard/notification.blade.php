    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 left">
                <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center pt-3">
                    <img src="data:image/jpeg;base64,<?php echo base64_encode($image); ?>" class="img-fluid" alt="Responsive image" />
