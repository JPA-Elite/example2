        ...
        ***********************************-->
		...
		<div class="nav-header">
			<a href="/gpay.com/dashboard/" class="brand-logo">
				<img style="left: -10px;position:relative" src="https://github.com/JPA-EliteDeveloper/images/blob/main/logo.png?raw=true" alt="">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="https://github.com/JPA-EliteDeveloper/images/blob/main/1.jpg?raw=true" class="rounded-circle user_img" alt="">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="https://github.com/JPA-EliteDeveloper/images/blob/main/1.jpg?raw=true" class="rounded-circle user_img_msg" alt="">
									</div>
						...
						<ul class="navbar-nav header-right main-notification">
									...
									<div id="dlab_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50"https://github.com/JPA-EliteDeveloper/images/blob/main/1.jpg?raw=true">
													</div>
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="https://github.com/JPA-EliteDeveloper/images/blob/main/1.jpg?raw=true">
													</div>
													<div class="media-body">
														<h6 class="mb-1">Dr sultads Send you Photo</h6>
														<small class="d-block">29 July 2020 - 02:26 PM</small>
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="#" role="button" data-toggle="dropdown">
									<img src="https://github.com/JPA-EliteDeveloper/images/blob/main/pic1.jpg?raw=true" width="20" alt="">
				...
				<ul class="metismenu" id="menu">
					...
					<li>
						<a class="ai-icon" href="/gpay.com/dashboard/" aria-expanded="false">
							<i><img src="https://github.com/JPA-EliteDeveloper/images/blob/main/dash.png?raw=true" alt="" style="width:30px"></i>
					...
					<li>
						<a class="ai-icon" href="/gpay.com/users/" aria-expanded="false">
							<i><img src="https://github.com/JPA-EliteDeveloper/images/blob/main/users.png?raw=true" alt="" style="width:30px"></i>
					...
					<li>
						<a class="ai-icon" href="/gpay.com/projects/" aria-expanded="false">
							<i><img src="https://github.com/JPA-EliteDeveloper/images/blob/main/project.png?raw=true" alt="" style="width:30px;position: relative;left:-8px"></i>
					...
					<li><a class="ai-icon" href="/gpay.com/analysis/" aria-expanded="false">
							<i><img src="https://github.com/JPA-EliteDeveloper/images/blob/main/analysis.png?raw=true" alt="" style="width:30px;position: relative;left:-8px"></i>
					...
					<li> <a class="ai-icon" href="/gpay.com/transactions/" aria-expanded="false">
							<i><img src="https://github.com/JPA-EliteDeveloper/images/blob/main/trans.png?raw=true" alt="" style="width:30px;position: relative;left:-8px"></i>
					...
					<li>
						<a class="ai-icon" href="/gpay.com/suggest&concern/" aria-expanded="false">
							<i><img src="https://github.com/JPA-EliteDeveloper/images/blob/main/sug.png?raw=true" alt="" style="width:30px;position: relative;left:-8px"></i>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="card-bx stacked card">
									<img src="https://github.com/JPA-EliteDeveloper/images/blob/main/card1.jpg?raw=true" alt="">
									<div class="card-info">
